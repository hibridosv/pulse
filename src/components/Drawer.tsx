...
const menuItems: MenuItem[] = [
  ...
  { label: "Control de cajas", href: "/cashdrawers", icon: <FaCashRegister className="mt-1 mr-2" /> },
  {
    ...
    children: [
      ...
      { label: "Registrar Producto", href: "/products" },
      { label: "Editar Producto", href: "/products" },
      { label: "Agregar Productos", href: "/products" },
      { label: "Descontar Productos", href: "/products" },
      { label: "Productos Relacionados", href: "/products" },
      { label: "Bajas Existencias", href: "/products" },
      { label: "Proximos Vencimientos", href: "/products" },
